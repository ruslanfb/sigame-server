...
страница «Foundations» (палитра, типографика Oswald/Manrope, плашки, состояния кнопки), страница «Screens» — 18 бордов:
игрок-мобайл P01–P07, табло-ТВ T01–T05, пульт ведущего H01–H04, игрок-десктоп D01–D02. Стиль: «современный Миллионер»
(индиго-градиенты, золото, шестиугольные плашки, свечение). Всё воспроизводится скриптами `design/penpot/*.js` через Penpot MCP.
Пустые страницы «Table»/«Host» можно удалить вручную.
